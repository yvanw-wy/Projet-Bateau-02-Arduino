...
Application app;
P(index_html) = "<!DOCTYPE html> <html lang=\"en\"> <head> <meta charset=\"utf-8\"> <meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\"> </head> <style> body { margin: 0; padding: 0; font-size: 1.3rem; } *, *::before, *::after { margin: 0; padding:0; box-sizing: border-box; } html { font-family: Arial, Helvetica, sans-serif; font-size: 1.2rem; overflow-x: hidden; } .d-flex { display: flex; } .align-items-center { align-items: center; } .justify-content-between { justify-content: space-between; } .hero { flex-direction: column; } .hero * { margin-top: 0.5rem; } .layout-1, .layout-2 { padding: 2rem; } .layout-1 div:last-of-type { font-size: 0.75rem; } h6, .layout-2 p { font-weight: normal } h6 span, .layout-2 .autonomie_bateau { font-weight: bold; } .layout-2 p { font-size: 0.75rem; } h4 { margin-top: 2em; } .layout-2 { margin: auto; margin-top: 2rem; position: relative; } button:focus, button:focus-within { outline: none; } header, .layout-2 { position: relative; overflow: hidden; } .hero div .layout-2:last-of-type { margin-bottom: 2rem; } @media only screen and (min-height: 1000px) { .hero { height: 89vh; } .layout-2{ top: 13.5rem; } } .layout-2 { margin-top: 3.35rem; } </style> <body> <div class=\"navbar\" style=\"background: white;display: flex;justify-content: space-between;align-items: center;color: #FCD34D;font-family: cursive;\"> <header class=\"d-flex justify-content-between align-items-center\" style=\"padding: 0.8em;background: #374151;flex: 1;\"> <a class=\"logo\" href=\"#\" style=\"text-decoration: none;font-size: 0.9rem;color: #FCD34D;\"> <h3>Brünhilde</h3> </a> </header> <div class=\"version\" style=\"position: absolute;right: 15px;background: #f4f5ff;padding: 1px 6px;font-size: 0.6rem;border-radius: 14px;color: black;font-family: unset;box-shadow: 0 0 transparent, 0 0 transparent, 0 10px 15px -3px rgb(0 0 0 / 15%), 0 4px 6px -2px rgb(0 0 0 / 5%);\"> <div>bêta</div> </div> <div class=\"current_mode\" style=\"position: absolute;right: 65px;font-size: 0.6rem;color: white;font-family: unset; display: flex;align-items: center;\"> <div> <span class=\"type_mode\">Radio</span> mode activated </div> </div> </div> <div class=\"hero\" style=\"background: #DBEAFE;display: flex;text-align: center;position: relative;\"> <div> <div class=\"layout-1\"> <h4>Your boat is at</h4> <div> <h6>Lat: <span class=\"latitude_gps\">0.0000</span></h6> <h6>Lon: <span class=\"longitude_gps\">0.0000</span></h6> </div> <h4 style=\"font-size: 1.1rem;margin-top: 2.9rem;\">Cap</h4> <div> <h6><span class=\"cap\">0</span>°</h6> </div> <div class=\"justify-content-between d-flex\"> <p class=\"\"><span class=\"current_consumption\">0</span> A</p> <p class=\"\"><span class=\"rotation_speed\">0</span> Rpm</p> </div> </div> </div> <div style=\"margin-top: 0;\"> <div class=\"layout-2\"> <div class=\"gauge_viewer mt-2\"> <h4>Speed</h4> <div>0 m/s</div> <h6 style=\"margin-top: 0.25rem;\">Max: <span class=\"max_speed\">3.77 m/s</span></h6> </div> <button class=\"commad_boat\" data-isOpen=\"No\" style=\"color: white;padding: 0.5rem 0.5rem;font-size: 0.9rem;border: none;margin-top: 1.2rem !important;border-radius: 5px;position: relative;z-index: 2;cursor: pointer;box-shadow: 0 0 transparent, 0 0 transparent, 0 10px 15px -3px rgba(0,0,0,0.02),0 4px 6px -2px rgba(0,0,0,0.05);background: #FBBF24;\">Command Brünhilde</button> <p><span class=\"autonomie_bateau\">5h</span> of autonomy</p> </div> </div> </div> <div class=\"footer\" style=\"background: #f4f5ff;font-size: 0.75rem;padding: 0.9rem;position: relative;z-index: 1;\"> <p style=\"text-align: center;\">&#64; Icam 2021</p> </div> <script> document.querySelector('button').onclick = function() { if(this.getAttribute(\"data-isOpen\") == \"No\"){ this.setAttribute(\"data-isOpen\", \"Yes\"); document.querySelector(\"button\").innerHTML = \"Switch to Radio\"; document.querySelector(\".type_mode\").innerHTML = \"Wifi\"; } else { this.setAttribute(\"data-isOpen\", \"No\"); document.querySelector(\"button\").innerHTML = \"Command brünhilde\"; document.querySelector(\".type_mode\").innerHTML = \"Radio\"; } } var xhr = new XMLHttpRequest(); xhr.onreadystatechange = function() { if(xhr.readyState == 4){ if (xhr.status == 200){ var tab = xhr.responseText.split(\",\"); document.querySelector(\".latitude_gps\").innerHTML = tab[0]; document.querySelector(\".longitude_gps\").innerHTML = tab[1]; document.querySelector(\".gauge_viewer div\").innerHTML = tab[2] + \" m/s\"; document.querySelector(\".cap\").innerHTML = tab[3]; document.querySelector(\".current_consumption\").innerHTML = tab[4]; document.querySelector(\".rotation_speed\").innerHTML = tab[5]; } } if(xhr.status == 404){ console.log(\"Error\", xhr.statusText); } } setInterval(function(){ xhr.open(\"GET\", \"http://192.168.4.1/datas\", true); xhr.send(); }, 100); let myStick_1 = new JoystickController(\"bawl_joystick_1\", 30, 2, 1); let myStick_2 = new JoystickController(\"bawl_joystick_2\", 30, 2, 0); </script> </body> </html>";
